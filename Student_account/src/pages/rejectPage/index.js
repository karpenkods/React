...
const RejectPage = (props) => {
    ...
    // Название страницы
    const [namePage, SetNamePage] = useState('rejectPage');
    ...
    return (
        <Layout
            ...
            <div className="reject-page">
                ...
                <div className="reject-page__tools">
                    <Filters 
                        text={'Сортировать: '}
                        valueBtnFirst={'Дата'}
                        valueBtnLast={'Имя'}
                ...
                <div className="reject-page__cards">
                    <LiteCardStudent 
                        visibleAddForm={visibleAddForm}
                        closeAddFormStudent={setVisibleAddForm}
                        buttons={[{icon: "fa-check-circle", label: "На практику", onChange: setAcceptPractic}]}
                        visibleBtnDelCard={visibleBtnDelCard}
                        namePage={namePage} />
                </div>
                <div className="reject-page__pagination">
                    <Pagination 
