...
const ApprovedPage = (props) => {
    ...
    // Название страницы
    const [namePage, SetNamePage] = useState('approvedPage');
    ...
    const setAcceptStudent = (id) => {
        // Отправка по Api
        console.log(id);
    };

    // Добавить студента в архив
    const setArchiveStudent = (id) => {
        // Отправить по Api
        console.log(id);
    };
    ...
    return (
        <Layout
            ...
            <div className="approved-page">
                ...
                <div className="approved-page__tools">
                    <Filters 
                        text={'Сортировать: '}
                        valueBtnFirst={'Дата'}
                        valueBtnLast={'Имя'}
                ...
                <div className="approved-page__cards">
                    <LiteCardStudent 
                        visibleAddForm={visibleAddForm}
                        buttons={[{icon: "fa-arrow-left", label: "В архив", onChange: setArchiveStudent}, {icon: "fa-check-circle", label: "На практику", onChange: setAcceptStudent}]}
                        closeAddFormStudent={setVisibleAddForm}
                        visibleBtnDelCard={visibleBtnDelCard}
                        namePage={namePage} />
                </div>
                <div className="approved-page__pagination">
                    <Pagination 
